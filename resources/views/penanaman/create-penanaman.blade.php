        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="content">
                       <form class="daftar-member" action="/tanam" method="post">
                        {{csrf_field()}}
                        <hr class="cross-area">
                        <div class="form-group">
                            <label for="nama">ID Buah:</label>
                            <select name='id_buah' class="form-control" id="wb">
                                @foreach($buah as $buah)
                                <option value="{{$buah->id_buah}}">{{$buah->nama_buah}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" >
                            ...
                            <select name='musim_tanam' class="form-control" id="wb">
